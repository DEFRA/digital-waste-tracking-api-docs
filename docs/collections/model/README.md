...
- An entity-relationship view of the main aggregates — Movement, Collection, Drop-off, Receipt — and the reference data they depend on.
- A journey state diagram showing how events transition a Movement between states (planned → in-collection → in-transit → dropped-off → accepted / rejected / returned), reconciled against the four terminal states named in the [glossary](../glossary.md).
